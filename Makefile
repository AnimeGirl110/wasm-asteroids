...
# FILE TYPES
SOURCE    := src/Main.cpp src/Controller.cpp src/Game.cpp src/Model.cpp src/View.cpp src/Background.cpp src/Asteroid.cpp
IMAGES    := 'png', 'jpg'
...
EM_SDL2   := $(EM_)/cache/sysroot/include/SDL2
EM_EMSC   := $(EM_)/system/include/emscripten
...
SETTINGS  := $(PRELOAD) $(EMRUN) $(USES) $(FORMATS) $(EXPORTS) $(MEMORY)
